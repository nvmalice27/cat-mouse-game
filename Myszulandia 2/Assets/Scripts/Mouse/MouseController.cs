...
public class MouseController : MonoBehaviour
{
    ...
    static Color StateColor(MouseState s) => s switch
    {
        ...
        MouseState.Heppi       => new Color(1.00f, 0.95f, 0.50f),  // żółty
        ...
        // Kolekcjonerskie
        MouseState.Zakochana      => new Color(1.00f, 0.70f, 0.80f),  // jasny róż
        MouseState.Czonstkujaca   => new Color(1.00f, 0.95f, 0.40f),  // złoty
        MouseState.Grobol         => new Color(0.55f, 0.90f, 0.45f),  // zielony
        MouseState.Paczurowa      => new Color(0.30f, 0.85f, 0.90f),  // turkus
        MouseState.Tanczaca       => new Color(0.80f, 0.50f, 1.00f),  // jasny fiolet
        MouseState.Makapaka       => new Color(1.00f, 0.85f, 0.20f),  // złoto
        MouseState.Smrodliwa      => new Color(0.60f, 0.45f, 0.30f),  // brąz
        ...
        MouseState.Pumpuzka       => Color.white,
        MouseState.Roztopiona     => Color.white,
        MouseState.Spankowa       => Color.white,
        MouseState.Czosnkowa      => Color.white,
